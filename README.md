...
* [X] On the followers/following screen, leverage the [CoordinatorLayout](http://guides.codepath.com/android/Handling-Scrolls-with-CoordinatorLayout#responding-to-scroll-events) to [apply scrolling behavior](https://hackmd.io/s/SJyDOCgU) as the user scrolls through the profile timeline.
* [X] User can view their direct messages (or send new ones)

The following **additional** features are implemented:

* [X] Embeeded Video in detail view
* [X] Background image in profile view
* [X] Implemented IntentService to save tweets in background service.
* [X] Used Lambda Expressions, GSON
